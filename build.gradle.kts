...
subprojects {
    ...
    aliucord {
        ...
        updateUrl.set("https://raw.githubusercontent.com/c10udburst-discord/aliucord-sendembeds/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/c10udburst-discord/aliucord-sendembeds/builds/%s.zip")
    }
